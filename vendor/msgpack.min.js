  ...
  return (function () {
    ...
    function a(t, e, i) {
      for (var o = e, a = o + i, c = [], u = ""; o < a; ) {
        ...
        c.length >= s &&
          ((u += String.fromCharCode.apply(String, r([], n(c), !1))),
          (c.length = 0));
      }
      return (
        c.length > 0 &&
    ...
    function U(t) {
      ...
      if (n >= 0 && r >= 0 && n <= b) {
        if (0 === r && n <= g) {
          ...
          return (e = new DataView(i.buffer)).setUint32(0, n), i;
        }
        var o = n / 4294967296,
          s = 4294967295 & n;
        return (
    ...
    function S(t) {
      ...
      switch (t.byteLength) {
        ...
        case 12:
          return { sec: w(e, 4), nsec: e.getUint32(0) };
        default:
          throw new p(
    ...
    var I = { type: v, encode: x, decode: B },
      E = (function () {
        function t() {
    ...
    var T = function (t) {
      ...
      k = (function () {
        function t(t) {
          var e, n, r, i, o, s, a, c;
          (this.extensionCodec =
            null !== (e = null == t ? void 0 : t.extensionCodec) && void 0 !== e
              ? e
              : E.defaultCodec),
            (this.context = null == t ? void 0 : t.context),
            (this.useBigInt64 =
              null !== (n = null == t ? void 0 : t.useBigInt64) &&
              void 0 !== n &&
              n),
            (this.maxDepth =
              null !== (r = null == t ? void 0 : t.maxDepth) && void 0 !== r
                ? r
                : 100),
            (this.initialBufferSize =
              null !== (i = null == t ? void 0 : t.initialBufferSize) &&
              void 0 !== i
                ? i
                : 2048),
            (this.sortKeys =
              null !== (o = null == t ? void 0 : t.sortKeys) &&
              void 0 !== o &&
              o),
            (this.forceFloat32 =
              null !== (s = null == t ? void 0 : t.forceFloat32) &&
              void 0 !== s &&
              s),
            (this.ignoreUndefined =
              null !== (a = null == t ? void 0 : t.ignoreUndefined) &&
              void 0 !== a &&
              a),
            (this.forceIntegerToFloat =
              null !== (c = null == t ? void 0 : t.forceIntegerToFloat) &&
              void 0 !== c &&
              c),
            (this.pos = 0),
        ...
        return (
          ...
          (t.prototype.doEncode = function (t, e) {
            ...
            null == t
              ...
              : "string" == typeof t
              ? this.encodeString(t)
              : this.useBigInt64 && "bigint" == typeof t
            ...
            var e,
              ...
              s = (function (t) {
                for (var e = t.length, n = 0, r = 0; r < e; ) {
                  ...
                  if (0 != (4294967168 & i))
                    if (0 == (4294965248 & i)) n += 2;
                    else {
                      if (i >= 55296 && i <= 56319 && r < e) {
                        var o = t.charCodeAt(r);
                        56320 == (64512 & o) &&
                          (++r, (i = ((1023 & i) << 10) + (1023 & o) + 65536));
                      }
          ...
          (t.prototype.encodeMap = function (t, e) {
            ...
            try {
              for (var s = T(i), a = s.next(); !a.done; a = s.next()) {
                var c = a.value,
                  u = t[c];
                (this.ignoreUndefined && void 0 === u) ||
                  (this.encodeString(c), this.doEncode(u, e + 1));
              }
            } catch (t) {
              n = { error: t };
            } finally {
      ...
      K = (function () {
        function t(t) {
          ...
          (this.totalPos = 0),
            ...
            (this.stack = []),
            (this.extensionCodec =
              null !== (e = null == t ? void 0 : t.extensionCodec) &&
              void 0 !== e
                ? e
                : E.defaultCodec),
            (this.context = null == t ? void 0 : t.context),
            (this.useBigInt64 =
              ...
              n),
            (this.maxStrLength =
              null !== (r = null == t ? void 0 : t.maxStrLength) && void 0 !== r
                ? r
                : d),
            (this.maxBinLength =
              null !== (i = null == t ? void 0 : t.maxBinLength) && void 0 !== i
                ? i
                : d),
            (this.maxArrayLength =
              null !== (o = null == t ? void 0 : t.maxArrayLength) &&
              void 0 !== o
                ? o
                : d),
            (this.maxMapLength =
              null !== (s = null == t ? void 0 : t.maxMapLength) && void 0 !== s
                ? s
                : d),
            (this.maxExtLength =
              null !== (a = null == t ? void 0 : t.maxExtLength) && void 0 !== a
                ? a
                : d),
            (this.keyDecoder =
              void 0 !== (null == t ? void 0 : t.keyDecoder)
                ? t.keyDecoder
                : V);
        }
        return (
          ...
          (t.prototype.createExtraByteError = function (t) {
            ...
            return new RangeError(
              "Extra "
                .concat(e.byteLength - n, " of ")
                .concat(e.byteLength, " byte(s) found at buffer[")
                .concat(t, "]")
            );
          }),
                ...
                return D(this, function (w) {
                  switch (w.label) {
                    ...
                    case 2:
                      return [4, n.next()];
                    case 3:
                      if (((r = w.sent()), (i = r.done))) return [3, 5];
                      (a = r.value), (e = !1);
                      try {
                        if (((h = a), c))
                    ...
                    case 5:
                      return [3, 12];
                    case 6:
                      return (f = w.sent()), (o = { error: f }), [3, 12];
                    case 7:
                      return (
                        w.trys.push([7, , 10, 11]),
              ...
              return D(this, function (d) {
                switch (d.label) {
                  ...
                  case 2:
                    return [4, F(o.next())];
                  case 3:
                    if (((s = d.sent()), (h = s.done))) return [3, 14];
                    (p = s.value), (i = !1), (d.label = 4);
                  case 4:
                    if ((d.trys.push([4, , 12, 13]), (a = p), e && 0 === r))
                      throw this.createExtraByteError(this.totalPos);
                    this.appendBuffer(a),
                      n &&
                  ...
                  case 7:
                    return [4, d.sent()];
                  case 8:
                    return d.sent(), 0 == --r ? [3, 9] : [3, 6];
                  case 9:
                    return [3, 11];
                  case 10:
                    if (!((c = d.sent()) instanceof W)) throw c;
                    return [3, 11];
                  case 11:
                  ...
                  case 14:
                    return [3, 21];
                  case 15:
                    return (u = d.sent()), (f = { error: u }), [3, 21];
                  case 16:
                    return (
                      d.trys.push([16, , 19, 20]),
          ...
          (t.prototype.doDecodeSync = function () {
            t: for (;;) {
              ...
              if (t >= 224) e = t - 256;
                ...
                (n = this.lookU8()), (e = this.decodeUtf8String(n, 1));
              else if (218 === t)
                (n = this.lookU16()), (e = this.decodeUtf8String(n, 2));
              else if (219 === t)
                (n = this.lookU32()), (e = this.decodeUtf8String(n, 4));
              else if (220 === t) {
                if (0 !== (r = this.readU16())) {
                  this.pushArrayState(r), this.complete();
                  continue t;
                ...
                (r = this.lookU16()), (e = this.decodeBinary(r, 2));
              else if (198 === t)
                (r = this.lookU32()), (e = this.decodeBinary(r, 4));
                ...
                (r = this.lookU8()), (e = this.decodeExtension(r, 1));
              else if (200 === t)
                (r = this.lookU16()), (e = this.decodeExtension(r, 2));
              else {
                if (201 !== t)
              ...
              for (var i = this.stack; i.length > 0; ) {
                ...
                if (o.type === O) {
                  ...
                  if (o.type === _) {
                    ...
                    (o.key = e), (o.type = "map_value");
                    continue t;
                  }
                  if (
                    ((o.map[o.key] = e), o.readCount++, o.readCount !== o.size)
                  ) {
                    (o.key = null), (o.type = _);
                    continue t;
                  }
          ...
          (t.prototype.decodeUtf8String = function (t, e) {
            ...
            if (this.bytes.byteLength < this.pos + e + t) throw R;
            var r,
              i = this.pos + e;
            return (
              (r =
                ...
                (null === (n = this.keyDecoder) || void 0 === n
                  ? void 0
                  : n.canBeCached(t))
                  ? this.keyDecoder.decode(this.bytes, i, t)
                  : (function (t, e, n) {
                      return n > u
                        ? (function (t, e, n) {
          ...
          (t.prototype.stateIsMapKey = function () {
            return (
              this.stack.length > 0 &&
              this.stack[this.stack.length - 1].type === _
            );
          }),
          (t.prototype.decodeBinary = function (t, e) {
            ...
            if (!this.hasRemaining(t + e)) throw R;
            var n = this.pos + e,
    ...
    function q(t) {
      return null != t[Symbol.asyncIterator]
        ? t
        : (function (t) {
    ...
    function Z(t, e) {
      return Q(this, void 0, void 0, function () {
        ...
        return Y(this, function (r) {
          return (n = q(t)), [2, new K(e).decodeAsync(n)];
        });
      });
    }
    function $(t, e) {
